...
export function NewConnection() {
  ...
  const getDefaultConnection = async () => {
    ...
    const config = {
      method: "get",
      url: "https://clafs.herokuapp.com/api/v1/connections/1",
      headers: {
    ...
    setLoading(true);
    try {
      let result = await normalAxios(config);
      if (result.data) {
        setConnExists(true);
      }
    } catch (error) {
                  ...
                  {connExists ? (
                    <>
                      <Typography variant="h5">
                        A user can have only 1 connection
                      </Typography>
                    </>
                  ) : (
                    <>
                      ...
                      <TextField
                        ...
                        onChange={(e) => {
                          let tempConn = { ...conn };
                          tempConn.azure_connection.account_name =
                            e.target.value;
                          setConn(tempConn);
                        }}
                      />{" "}
                      <TextField
                        ...
                        onChange={(e) => {
                          let tempConn = { ...conn };
                          tempConn.azure_connection.account_key =
                            e.target.value;
                          setConn(tempConn);
                        }}
                      />{" "}
                      <TextField
                        ...
                        onChange={(e) => {
                          let tempConn = { ...conn };
                          tempConn.azure_connection.container_name =
                            e.target.value;
                          setConn(tempConn);
                        }}
                      />
                      ...
                      <TextField
                        ...
                        onChange={(e) => {
                          let tempConn = { ...conn };
                          tempConn.gcp_connection.connection_json =
                            e.target.value;
                          setConn(tempConn);
                        }}
                      />
