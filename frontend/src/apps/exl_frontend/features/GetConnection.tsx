                    ...
                    <Box sx={{ pt: 2, pl: 1 }}>
                      <Accordion sx={{ pt: 2, pl: 1 }}>
                        ...
                        <AccordionDetails>
                          <PassField
                            name="Account Name"
                            password={conn.azure_connection.account_name}
                          />
                          <PassField
                            name="Account Key"
                            password={conn.azure_connection.account_key}
                          />
                          <PassField
                            name="Container Name"
                            password={conn.azure_connection.container_name}
                          />
                        </AccordionDetails>
                      </Accordion>
                      ...
                      <Accordion sx={{ pt: 2, pl: 1 }}>
                        ...
                        <AccordionDetails>
                          <PassField
                            name="Access Key"
                            password={conn.s3_connection.access_key}
                          />
                          <PassField
                            name="Secret Key"
                            password={conn.s3_connection.secret_key}
                          />
                          <PassField
                            name="Bucket Name"
                            password={conn.s3_connection.bucket_name}
                          />
                        </AccordionDetails>
                      </Accordion>
                    </Box>
