              ...
              <Card>
                <CardContent>
                  ...
                  <Button
                    ...
                    variant="contained"
                    component="label"
                    disabled={fileUploadLink.id}
                    onClick={async () => {
                      const myFormData = new FormData();
                      myFormData.append(
                        `file_${getUploadType(bucketType)}`,
                      ...
                      var config = {
                        method: "post",
                        url: "https://clafs.herokuapp.com/api/v1/files/",
                        headers: {
                  ...
                  {fileUploadLink.id && (
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          fileUploadLink.file ||
                            fileUploadLink.file_s3 ||
                            fileUploadLink.file_azure ||
                            fileUploadLink.file_gcloud
                        )
                      }
                      component="label"
                    >
