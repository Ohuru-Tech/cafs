...
## App Structure
All the apps are located in the `cloud_agnostic_storage/apps` folder. The project uses a custom `startapp` command, refer `cloud_agnostic_storage/management/commands/startapp.py` for more information.
...
INSTALLED_APPS = [
    ...
    'cloud_agnostic_storage.apps.<app_name>.apps.<app_name_capitalized>Config',
    ...
]
```
...
INSTALLED_APPS = [
    ...
    'cloud_agnostic_storage.apps.foo.apps.FooConfig',
    ...
]
```
