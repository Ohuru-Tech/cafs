...
from cloud_agnostic_storage.urls.auth_urls import rest_auth_urls
from cloud_agnostic_storage.urls.swagger_urls import swagger_urlpatterns
from cloud_agnostic_storage.urls.versioned_urls import versioned_urls
